...
function draw() {
  ...
  // the protective shield dome sits over the whole reef, on top of
  // everything else, like a glass/force-field bubble — it starts out
  // invisible and grows as "good" items land on coral (see spawnDebris /
